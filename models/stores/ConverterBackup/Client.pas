...
type
  ...
  TBeforeSendDelegate = reference to function(url: string; Options: SendOptions): TBeforeSendResult;
  TAfterSendFunc      = reference to function(response: string; data: string)        : string;
